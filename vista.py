...
class CreacionVentana():
    ...
    def __init__(self, master):
        ...
        boton_modificar = Button(master, text="Modificar", width= self.ancho, fg="purple", command=lambda: self.ObjetoOp.modificar(self.a_val, self.b_val, self.c_val, self.d_val, self.e_val, self.f_val, self.planilla))
